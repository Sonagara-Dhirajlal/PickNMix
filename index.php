...
$resultreview = mysqli_query($conn, $review);
    ...
    <div class="container py-5">
        <div class="tab-class text-center">
            ...
            <div class="tab-content">
                <?php $index = 1; // Initialize $index at 1 ?>
                <?php foreach ($categories as $category) { ?>
                <?php 
                   $id = $category['Id']; // Set $id for the current category
                 ?>
                <div id="<?= "tab-".$index ?>" class="tab-pane fade p-0 <?php if ($index === 1) echo 'show active'; ?>">
                    <?php $index++; // Increment $index after each iteration ?>
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="row g-4">
                                <?php
                        // Execute the query for products in the current category
                        ...
                        ?>
                                    ...
                                    <div class="rounded position-relative fruite-item">
                                        ...
                                        <form action="./api/cart/insert" method="POST">
                                            ...
                                            <div class="fruite-img"
                                                ...
                                                <img src="<?= "./admin/assets/images/product/" . $product["Image"]; ?>"
                                                    alt="product-image" class="img-fluid w-100 h-100"
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <p class="text-dark fs-5 fw-bold mb-0">rs.<?= $product['Price']; ?>
                                ...
                                <?php } // End of product foreach loop ?>

                            </div>
                        </div>
                    </div>
                </div>
                <?php } // End of category foreach loop ?>
            </div>
                    ...
                    <div class="service-item bg-primary rounded border border-primary">
                        ...
                        <div class="px-4 rounded-bottom"><br><br><br>
                            <div class="service-content bg-secondary text-center p-4 rounded">
                                ...
                                <h3 class="mb-0">Discount 100rs.</h3>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="border border-primary rounded position-relative vesitable-item"
                ...
                <div class="p-4 rounded-bottom">
                    ...
                    <div class="d-flex justify-content-between flex-lg-wrap">
                        <p class="text-dark fs-5 fw-bold mb-0">rs.<?= $rows['Price'] ?> / <?= $product['Measurement'] ?>
                        </p>
        ...
        <div class="row g-4">
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <a href="#" class="h5">Pure Wheat</a><br><br>
                            ...
                            <h4 class="mb-3">rs. 500</h4><br>
                            <form action="./api/cart/insert" method="POST" class="d-inline">
                                <input type="hidden" name="userid" value="<?= $userId ?>">
                                <input type="hidden" name="image" value="58271-wheat.jpeg">
                                <input type="hidden" name="name" value="Wheat">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <img src="<?= urlOf('assets/img/chips.jpeg') ?>" class="img-fluid rounded-circle w-100"
                                alt="">
                        </div>
                        <div class="col-6">
                            <a href="#" class="h5">Chips</a><br><br>
                            <!-- <div class="d-flex my-3">
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                            ...
                            <h4 class="mb-3">rs.20</h4><br>
                            <form action="./api/cart/insert" method="POST" class="d-inline">
                                <input type="hidden" name="userid" value="<?= $userId ?>">
                                <input type="hidden" name="image" value="95302-chips.jpeg">
                                <input type="hidden" name="name" value="spageti">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <a href="#" class="h5">Best Sugar</a><br><br>
                            <!-- <div class="d-flex my-3">
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                            ...
                            <h4 class="mb-3">rs. 250</h4>
                            <form action="./api/cart/insert" method="POST" class="d-inline">
                                <input type="hidden" name="userid" value="<?= $userId ?>">
                                <input type="hidden" name="image" value="37303-sugar.jpeg">
                                <input type="hidden" name="name" value="sugar">
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <a href="#" class="h5">Noodles</a><br><br>
                            <!-- <div class="d-flex my-3">
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                            ...
                            <h4 class="mb-3">rs. 50</h4>
                            <form action="./api/cart/insert" method="POST" class="d-inline">
                                <input type="hidden" name="userid" value="<?= $userId ?>">
                                <input type="hidden" name="image" value="5020-noodle 1.jpg">
                ...
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            ...
                            <h4 class="mb-3">rs. 20</h4>
                            <form action="./api/cart/insert" method="POST" class="d-inline">
                                <input type="hidden" name="userid" value="<?= $userId ?>">
                                <input type="hidden" name="image" value="68825-salt 2.jpg">
                                <input type="hidden" name="name" value="salt">
                                <input type="hidden" name="price" value="20">
                                <button type="submit"
                                    class="btn border border-secondary rounded-pill px-3 text-primary">
                                    <i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart
                ...
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            ...
                            <h4 class="mb-3">rs. 40</h4>
                            <form action="./api/cart/insert" method="POST" class="d-inline">
                                <input type="hidden" name="userid" value="<?= $userId ?>">
                                <input type="hidden" name="image" value="12423-soap 1.jpeg">
                                <input type="hidden" name="name" value="soap">
...
<div class="container-fluid testimonial py-5">
    <div class="container py-5">
        ...
        <div class="owl-carousel testimonial-carousel">
            ...
            <?php while($rows=mysqli_fetch_assoc($resultreview)) { ?>
            ...
            <div class="testimonial-item img-border-radius bg-light rounded p-4">
                <div class="position-relative">
                    ...
                    <div class="mb-4 pb-4 border-bottom border-secondary">
                        <p class="mb-0"><?= $rows['Review'] ?>
                        </p>
                    </div>
                    <div class="d-flex align-items-center flex-nowrap">
                        <div class="bg-secondary rounded">
                            <img src="<?= urlOf('assets/img/testimonial.jpg') ?>" class="img-fluid rounded"
                                style="width: 100px; height: 100px;" alt="">
                        </div>
                        <div class="ms-4 d-block">
                            <h4 class="text-dark"><?= $rows['Name'] ?></h4>
                            <p class="m-0 pb-3"><?= $rows['Email'] ?></p>
                        </div>
                    </div>
                </div>
            </div>
