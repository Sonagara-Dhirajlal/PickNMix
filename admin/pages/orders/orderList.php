                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">orderList</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                                            ...
                                            <td>
                                                <div class="overlay-edit">
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item m-0"><a href="../../api/orders/delete ?deleteId=<?= $rows['Id'] ?>"
                                    ...
                                    <?php while ($orders = mysqli_fetch_assoc($orderDetailsResult)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- <div class="overlay-edit">
                                                    <ul class="list-inline mb-0">
                                                        <li class="list-inline-item m-0"><a href="../../api/orderdetails/delete ?deleteId=<?= $orders['OrderId'] ?>" class="avtar avtar-s btn bg-white btn-link-danger">
                                                                <i class="ti ti-trash f-18"></i></a></li>
                                                    </ul>
                                                </div> -->
                                            </td>
                                        </tr>
