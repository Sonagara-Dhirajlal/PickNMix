                ...
                <div class="card border-0 table-card user-profile-list">
                    <div class="card-body">
                        <div class="text-end p-sm-4 pb-sm-2">
                            <a href="<?=  urlOf('pages/role/addRole') ?>" class="btn btn-primary"> <i class="ti ti-plus f-18"></i> Add
                                Role
                            </a>
                                        ...
                                        <td><?= $rows['Rolename'] ?>
                                            <div class="overlay-edit">
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item m-0"><a href="../../api/role/delete ?deleteId=<?= $rows['Id'] ?>"
